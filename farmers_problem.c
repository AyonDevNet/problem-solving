...
int main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        int new_farmers;
        int days;
        scanf("%d %d %d", &old_farmers, &new_farmers, &days);
        
        int total_work = old_farmers * days;
        
        int total_farmers = old_farmers + new_farmers;
        int new_days = total_work / total_farmers;
        
        int answer = days - new_days;
